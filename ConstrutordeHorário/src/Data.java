...
//	Novo construtor que recebe informa��es de data e hor�rio
...
//	Monta a string de impress�o da data

		if (hora == -1) {
//	Se hora for -1, significa que os dados de hor�rio n�o ser�o necess�rios.
//	Ent�o visualiza-se s� a data
			System.out.println(data);
		} else {
//	Cria uma parte da string do hor�rio 
...
//	Se hora � maior ou igual a 12, precisamos diminuir 12 da hora para conseguir o formato 12 horas,
